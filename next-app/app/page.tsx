...
import style1 from "../styles/next1.module.css";
import style2 from "../styles/next2.module.css";
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
        ...
        >
          <h2 className={`mb-3 text-2xl font-semibold`}>
            Docs{" "}
            <span className="inline-block transition-transform group-hover:translate-x-24 motion-reduce:transform-none ease-in-out duration-500">
              -&gt;
            </span>
          </h2>
        ...
        >
          <h2 className={`mb-3 text-2xl font-semibold`}>
            Templates{" "}
            <span className="inline-block transition-transform group-hover:translate-x-20 motion-reduce:transform-none ease-in-out duration-500">
              -&gt;
            </span>
          </h2>
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
